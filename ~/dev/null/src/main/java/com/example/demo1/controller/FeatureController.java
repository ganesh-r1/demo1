...
public class FeatureController {
    ...
    public Map<String, Object> getFeatureStatus() {
        ...
        Map<String, Object> config = configHelper.buildConfiguration(docFeeEnabled);
        String systemMode = configHelper.determineSystemMode(docFeeEnabled);
    ...
    public int getProcessingPriority(@RequestParam String documentType) {
        ...
        return configHelper.calculateProcessingPriority(docFeeFlag, documentType);
    }
}
...
public class FeatureControlCheckUtil {
    ...
    // REMOVED: isCqSetDocFeeCapitalizedWithYValueEnabled()
    // REMOVED: CQ_SET_DOC_FEE_CAPITALIZED_Y constant
    // REMOVED: getFallbackValue() branch for CQ_SET_DOC_FEE_CAPITALIZED_Y 
    // REMOVED: all references to CQ_SET_DOC_FEE_CAPITALIZED_Y

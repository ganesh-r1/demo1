...
public class FeatureControlCheckUtil {
    ...
    // REMOVE: isCqSetDocFeeCapitalizedWithYValueEnabled();
    // REMOVE references to CQ_SET_DOC_FEE_CAPITALIZED_Y in known features
    // REMOVE fallback logic for that flag
    // REMOVE refreshFeature() for CQ_SET_DOC_FEE_CAPITALIZED_Y
    // Existing methods for EC_INSURANCE_REDESIGN retained

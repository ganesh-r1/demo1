...
public class InvoiceGenerator {
    ...
    public List<String> generateInvoiceItems(BigDecimal baseAmount, String clientType) {
        ...
        boolean capitalizedFeeActive = true;
        boolean insuranceRedesignActive = false;
    ...
    private void addConditionalItems(List<String> items, boolean docFeeEnabled, boolean insuranceEnabled, String clientType) {

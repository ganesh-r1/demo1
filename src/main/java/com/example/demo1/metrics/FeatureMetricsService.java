...
public class FeatureMetricsService {
    ...
    // Removed insuranceUsageCounter and combinedUsageCounter for insurance redesign
    ...
    private void trackFeatureUsage(String operation, boolean docFeeEnabled) {
        ...
        usageEvent.put("feature_combination", docFeeEnabled ? "DOC_FEE_ONLY" : "NONE_ENABLED");

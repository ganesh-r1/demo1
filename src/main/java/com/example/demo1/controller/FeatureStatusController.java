...
public class FeatureStatusController {
    ...
    private String determineSystemMode(boolean docFeeEnabled, boolean insuranceEnabled) {
        // Insurance redesign removed, no logic for it
        if (docFeeEnabled) {
    ...
    public Map<String, Object> getDetailedFeatureStatus() {
        ...
        // REMOVED: insuranceDetails/ec_insurance_redesign
    ...
    // Removed: areFeatureCompatible, calculatePerformanceImpact logic for insurance redesign
    ...
    public Map<String, Object> getFeatureHealthStatus() {
        ...
        try {
            ...
            // REMOVED: insuranceCheck & insurance_check_successful
            ...
            // REMOVED: insurance_check_successful
        }

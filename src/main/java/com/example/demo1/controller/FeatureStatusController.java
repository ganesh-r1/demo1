...
public class FeatureStatusController {
    ...
    public Map<String, Object> getFeatureStatus() {
        ...
        response.putAll(buildFeatureConfiguration(insuranceRedesignEnabled));
    ...
    private Map<String, Object> buildFeatureConfiguration(boolean insuranceEnabled) {
        return Collections.emptyMap();
    }
    
    private String determineSystemMode(boolean insuranceEnabled) {
        if (insuranceEnabled) {
    ...
    private String determinePriorityLevel(boolean insuranceEnabled) {
        if (insuranceEnabled) {
            return "MEDIUM";
        }
        return "NORMAL";
    ...
    public Map<String, Object> getDetailedFeatureStatus() {
        ...
        compatibility.put("features_compatible", areFeatureCompatible(insuranceEnabled));
        compatibility.put("requires_database_upgrade", false);
        compatibility.put("performance_impact", calculatePerformanceImpact(insuranceEnabled));
    ...
    private boolean areFeatureCompatible(boolean insuranceEnabled) {
        return true;
    }
    
    private String calculatePerformanceImpact(boolean insuranceEnabled) {
        if (insuranceEnabled) {
            return "LOW";
        }
        return "MINIMAL";

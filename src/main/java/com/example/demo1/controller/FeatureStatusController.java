...
public class FeatureStatusController {
    ...
    public Map<String, Object> getFeatureStatus() {
        ...
        // REMOVE: boolean insuranceRedesignEnabled = FeatureControlCheckUtil.isEcInsuranceRedesignEnabled();
        
        // Add individual feature statuses
        response.put("cq_set_doc_fee_capitalized_y_status", docFeeCapitalizedEnabled);
        // REMOVE: response.put("ec_insurance_redesign_status", insuranceRedesignEnabled);
        
        // REMOVE: response.putAll(buildFeatureConfiguration(docFeeCapitalizedEnabled, insuranceRedesignEnabled));
    ...
    public Map<String, Object> getDetailedFeatureStatus() {
        ...
        // REMOVE: insuranceDetails
        // REMOVE: response.put("ec_insurance_redesign", insuranceDetails);
        response.put("cq_set_doc_fee_capitalized_y", docFeeDetails);
        
        // System compatibility
        Map<String, Object> compatibility = new HashMap<>();
        // REMOVE: compatibility.put("features_compatible", areFeatureCompatible(docFeeEnabled, insuranceEnabled));
        compatibility.put("features_compatible", true);
        compatibility.put("requires_database_upgrade", false);
        compatibility.put("performance_impact", "MINIMAL");
    ...
    public Map<String, Object> getFeatureHealthStatus() {
        ...
        try {
            ...
            // REMOVE: boolean insuranceCheck = FeatureControlCheckUtil.isEcInsuranceRedesignEnabled();
            
            health.put("feature_service_status", "HEALTHY");
            health.put("doc_fee_check_successful", true);
            // REMOVE: health.put("insurance_check_successful", true);
            ...
            // REMOVE: health.put("insurance_check_successful", false);
        }

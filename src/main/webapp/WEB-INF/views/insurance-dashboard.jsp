...
<%
    // REMOVE: isInsuranceRedesignEnabled logic and dependent variables
...
<body class="${layoutClass}">
    ...
    <div class="feature-indicator" style="background-color: #FF9800; color: white;">
        EC_INSURANCE_REDESIGN: REMOVED
    </div>

    <div class="container">
        <!-- Header section always classic -->
        <header>
        ...
        <main class="main-content">
            <!-- Only classic insurance products section -->
            ...
            <!-- Claims processing section only standard -->
    ...
    <!-- Feature-specific JavaScript only for classic -->
    <script>
        ...
        // Common JavaScript for mode
        console.log('Insurance Redesign Feature: REMOVED');

...
<%
    ...
    // boolean isInsuranceRedesignEnabled = FeatureControlCheckUtil.isEcInsuranceRedesignEnabled(); // removed
    pageContext.setAttribute("insuranceRedesignEnabled", false);
    
    // Set theme and layout (always classic)
...
<head>
    ...
    <!-- Conditional CSS based on feature flag (always classic) -->
...
<body class="${layoutClass}">
    ...
    <div class="feature-indicator" style="background-color: #FF9800; color: white;">
        EC_INSURANCE_REDESIGN: DISABLED
    </div>

    <div class="container">
        <!-- Header section with conditional rendering (always classic) -->
        <header>
        ...
        <main class="main-content">
            <!-- Insurance products section (always standard) -->
            ...
            <!-- Claims processing section (always standard) -->
    ...
    <!-- Feature-specific JavaScript (always standard) -->
    <script>
        ...
        console.log('Insurance Redesign Feature: false');
        console.log('UI Theme: classic-theme');
    </script>
</body>
</html>

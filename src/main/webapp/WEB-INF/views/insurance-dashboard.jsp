...
<%
    // REMOVED: boolean isInsuranceRedesignEnabled = FeatureControlCheckUtil.isEcInsuranceRedesignEnabled();
    boolean isInsuranceRedesignEnabled = false;
...
<body class="${layoutClass}">
    ...
    <div class="container">
        <!-- Header section (always classic now) -->
        <header>
        ...
        <main class="main-content">
            ...
            <!-- No analytics/insights for redesign OFF -->
        </main>
    </div>

    <!-- Only Standard JavaScript included now -->
    <script>
        // Common JavaScript for classic mode

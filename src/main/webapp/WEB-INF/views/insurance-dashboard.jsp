...
<head>
    ...
    <!-- Only load modern theme CSS/scripts -->
...
<body class="${layoutClass}">
    ...
    <div class="container">
        <!-- Header section with only redesigned UI -->
        <header>
        ...
        <main class="main-content">
            <!-- Insurance products section with redesigned UI -->
            ...
            <!-- Claims processing section with redesigned UI -->
            ...
            <!-- Analytics and insights (only enhanced) -->
    ...
    <!-- Feature-specific JavaScript: Always enable enhanced features -->
    <script>
        ...
        // Common JavaScript for both modes (now always modern)

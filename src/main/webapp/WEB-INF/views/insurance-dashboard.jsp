...
<%
    ...
    boolean isInsuranceRedesignEnabled = false; // REMOVED: FeatureControlCheckUtil.isEcInsuranceRedesignEnabled();
    pageContext.setAttribute("insuranceRedesignEnabled", isInsuranceRedesignEnabled);
    
    // Set theme and layout to legacy
...
<body class="${layoutClass}">
    ...
    <script>
        // All enhanced (redesign) features removed
        console.log('Insurance Redesign Feature: DISABLED');
